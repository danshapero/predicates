...
REAL orient3dadapt(const REAL *pa, const REAL *pb, const REAL *pc, const REAL *pd,
	REAL permanent) {
...
REAL incircleadapt(const REAL *pa, const REAL *pb, const REAL *pc, const REAL *pd,
	...
	if(adxtail != 0.0) {
		...
		temp32alen = fast_expansion_sum_zeroelim(temp16alen,
			temp16a,
			temp16blen,
			temp16b,
			temp32a);
	...
	if((adxtail != 0.0) || (adytail != 0.0)) {
		...
		if(adxtail != 0.0) {
			...
			temp48len  = fast_expansion_sum_zeroelim(temp16alen,
				 temp16a,
				 temp32alen,
				 temp32a,
				 temp48);
			finlength  = fast_expansion_sum_zeroelim(finlength,
				 finnow,
				 temp48len,
				 temp48,
				 finother);
			...
			temp32blen = fast_expansion_sum_zeroelim(temp16alen,
				temp16a,
				temp16blen,
				temp16b,
				temp32b);
			temp64len  = fast_expansion_sum_zeroelim(temp32alen,
				 temp32a,
				 temp32blen,
				 temp32b,
				 temp64);
...
REAL inspherefast(const REAL *pa, const REAL *pb, const REAL *pc, const REAL *pd,
	const REAL *pe) {
...
REAL insphereexact(const REAL *pa, const REAL *pb, const REAL *pc, const REAL *pd,
	const REAL *pe) {
...
REAL insphereslow(const REAL *pa, const REAL *pb, const REAL *pc, const REAL *pd,
	const REAL *pe) {
...
REAL insphereadapt(const REAL *pa, const REAL *pb, const REAL *pc, const REAL *pd,
	const REAL *pe, REAL permanent) {
	INEXACT REAL aex, bex, cex, dex, aey, bey, cey, dey, aez, bez, cez, dez;
	REAL		 det, errbound;
...
REAL insphere(const REAL *pa, const REAL *pb, const REAL *pc, const REAL *pd,
	const REAL *pe) {
	REAL aex, bex, cex, dex;
	REAL aey, bey, cey, dey;
	REAL aez, bez, cez, dez;
